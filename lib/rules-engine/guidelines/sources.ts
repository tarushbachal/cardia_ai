...
export const SOURCES = {
  ...
  /** Current US lipid guideline — risk-based LDL-C goals + statin-discussion thresholds. */
  accAhaDyslipidemia2026: {
    ...
    year: 2026,
    reference: "LDL-C goals; ≥190 mg/dL therapy-discussion threshold",
  ...
  /** hs-CRP cardiovascular relative-risk categories. */
  ahaCdcInflammation2003: {
    ...
    year: 2003,
    reference: "hs-CRP relative-risk categories (<1, 1–3, >3 mg/L)",
