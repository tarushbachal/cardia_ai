...
export const hsCRP: BiomarkerDefinition = {
  ...
  bands: [
    ...
    },
    {
      ...
      note: "Between 1 and 3 mg/L is the 'average relative risk' category. hs-CRP reflects general inflammation, so it's best read alongside your other results by your doctor.",
    },
    {
      min: 3,
      max: 10,
      ...
      note: "Above 3 mg/L is the 'higher relative risk' category in the AHA/CDC statement. Because hs-CRP can rise temporarily with everyday infections, a doctor may suggest rechecking it when you're well.",
    },
    {
      min: 10,
      tier: "attention",
