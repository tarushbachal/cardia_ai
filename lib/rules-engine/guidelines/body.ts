...
export const bmi: BiomarkerDefinition = {
  ...
  bands: [
    ...
    },
    {
      ...
      note: "A BMI of 18.5 to 24.9 is the WHO 'healthy weight' range.",
    },
    {
      min: 25,
      max: 30,
      tier: "borderline",
      label: "Overweight",
      note: "A BMI of 25 to 29.9 is the WHO 'overweight' category. BMI does not capture muscle mass or fat distribution, so interpret it alongside other measures.",
    },
    {
      min: 30,
      max: 35,
      ...
      note: "A BMI of 30 to 34.9 is WHO obesity class I. BMI is a screen, not a diagnosis, discuss management with your physician.",
    },
    {
      min: 35,
      max: 40,
      ...
      note: "A BMI of 35 to 39.9 is WHO obesity class II. This range is associated with higher cardiovascular and metabolic risk and warrants medical review.",
    },
    {
      min: 40,
      tier: "attention",
