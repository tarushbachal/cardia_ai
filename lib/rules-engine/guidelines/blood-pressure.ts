...
export const systolicBP: BiomarkerDefinition = {
  ...
  bands: [
    ...
    },
    {
      ...
      tier: "borderline",
      label: "Elevated",
      note: "120 to 129 mmHg systolic is the 'elevated' category in the 2025 AHA/ACC guideline. The categories come from the average of several proper readings, so this is a good one to confirm with your doctor.",
    },
    {
      min: 130,
      max: 140,
      tier: "borderline",
      label: "Stage 1",
      note: "130 to 139 mmHg systolic falls in 'stage 1' in the 2025 AHA/ACC guideline. Because readings vary, a clinician confirms the category from repeated, properly taken measurements.",
    },
    {
      min: 140,
      tier: "attention",
...
export const diastolicBP: BiomarkerDefinition = {
  ...
  bands: [
    ...
    },
    {
      ...
      tier: "borderline",
      label: "Stage 1",
      note: "80 to 89 mmHg diastolic falls in 'stage 1' in the 2025 AHA/ACC guideline. Readings vary, so a clinician confirms the category from repeated, properly taken measurements.",
    },
    {
      min: 90,
      tier: "attention",
